  			...
  			<div class="menueMiddle leftFloat">
	  			<div class="menue">
	  				<ol >
	  					...
	  					<li><a class="visitedColor visited" href="<%=path%>/home/page/dynamic_fm.do" target="_self">番迷动态</a></li>
  	...
  	<div class="aboutFmMiddle">
	  	<div class="aboutFmBlock">
	  		<div class="aboutFmCnt">
	  			<div class="dynamicFmRow">
	  				<div class="dynamicLeftColumn leftFloat">
	  				</div>
	  				<div class="dynamicRightColumn leftFloat">
		  				<h2 class="dynamicFmH2">“番迷”团队开发用户一键实名认证功能，对接大学教务系统</h2>
		  				<p class="pFirstLine">2014-05-01</p>
		  				<p class="pSecondLine">番迷app帮助用户做到真正的实名认证系统。用户使用学籍号完成实名认证。用户通过实名</p>
		  				<p class="pSecondLine">认证得到“番迷”app更加丰富多彩的功能服务，方便同学通过实名来交朋友。</p>
	  				</div>
	  				<div class="dynamicFmHr clear">
			  			<hr/>
	  				</div>
